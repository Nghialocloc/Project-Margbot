...
public class RopeEditor : Editor
{
    ...
    public void HandleFunc(int controlID, Vector3 position, Quaternion rotation, float size, EventType eventType)
    {
    ...
    public void SolidHandleFunc(int controlID, Vector3 position, Quaternion rotation, float size, EventType eventType)
    {
        Handles.Label(position, new GUIContent(dotHandleTexture), dothandleStyle);
    }

    public void DeleteHandleFunc(int controlID, Vector3 position, Quaternion rotation, float size, EventType eventType)
    {
        GUI.color = Color.red;
        Handles.Label(position, new GUIContent(nodeTexture), handleStyle);
        GUI.color = Color.white;
